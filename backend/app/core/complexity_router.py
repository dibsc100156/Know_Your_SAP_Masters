"""
complexity_router.py Ã¢ÂÂ Phase L5: Complexity-Based Query Routing
==============================================================
Evaluates every incoming query's complexity and routes it to the appropriate
execution path Ã¢ÂÂ from instant meta-path fast-path to full multi-agent swarm.

Decision tiers:
  TRIVIAL  (< 0.05) Ã¢ÂÂ Meta-Path fast-path ONLY, skip all expensive steps
  SIMPLE   (0.05Ã¢ÂÂ0.30) Ã¢ÂÂ Standard orchestrator, skip Graph traversal
  COMPLEX  (0.30Ã¢ÂÂ0.50) Ã¢ÂÂ Full orchestrator incl. Graph RAG + Voting Executor
  EXPERT   (Ã¢ÂÂ¥ 0.50)    Ã¢ÂÂ Delegate to Multi-Agent Domain Swarm

Tuning notes (2026-04-20):
  - ~120 patterns across 8 dimensions (added qty_threshold, structural boosts)
  - Single cross_module_join Ã¢ÂÂ score 0.24 Ã¢ÂÂ SIMPLE
  - 2 dims (e.g. comparison + cross_module) Ã¢ÂÂ 0.32 Ã¢ÂÂ COMPLEX
  - 3+ dims with negotiation Ã¢ÂÂ 0.48 Ã¢ÂÂ COMPLEX/EXPERT
  - Structural signals add 0.05Ã¢ÂÂ0.26 on top of semantic score
...
# ============================================================================
# Complexity Analyzer Ã¢ÂÂ TUNED 2026-04-20
# ============================================================================

class ComplexityAnalyzer:
    """
    8-dimension scoring. Each dimension fires at 0.8 if ANY pattern matches.
    Weighted sum + structural boost Ã¢ÂÂ composite score.

    Key calibration (2026-04-20):
      TRIVIAL < 0.05   (pure lookup, no signals)
      SIMPLE  0.05Ã¢ÂÂ0.30  (1 semantic dim OR 2+ structural signals)
      COMPLEX 0.30Ã¢ÂÂ0.50  (2 semantic dims OR 1 semantic + structural Ã¢ÂÂ¥0.15)
      EXPERT  Ã¢ÂÂ¥ 0.50   (3+ semantic dims OR negotiation/qm dimension)

    Example scores:
      "vendor payment terms"                    Ã¢ÂÂ 0.07 (struct only) Ã¢ÂÂ TRIVIAL
      "vendor payment terms for co code 1010"   Ã¢ÂÂ 0.22 (struct 0.22) Ã¢ÂÂ SIMPLE
      "open POs above 50000"                   Ã¢ÂÂ 0.32 (qty_threshold) Ã¢ÂÂ SIMPLE
      "compare vendor payment vs customer credit" Ã¢ÂÂ 0.59 (multi+cmp+xmod+struct) Ã¢ÂÂ EXPERT
    """

    # Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Semantic dimension patterns Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

    COMPLEXITY_INDICATORS: Dict[str, List[str]] = {
        # Ã¢ÂÂÃ¢ÂÂ 1. Multi-entity: 2+ business entities mentioned Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "multi_entity": [
        ...
        # Ã¢ÂÂÃ¢ÂÂ 2. Aggregation: query asks for totals, counts, groupings Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "aggregation": [
        ...
        # Ã¢ÂÂÃ¢ÂÂ 3. Comparison: compares or ranks entities Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "comparison": [
        ...
        # Ã¢ÂÂÃ¢ÂÂ 4. Temporal: time dimension present Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "temporal": [
        ...
        # Ã¢ÂÂÃ¢ÂÂ 5. Cross-module join Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "cross_module_join": [
            r"vendor.*material", r"material.*vendor",
            r"vendor.*customer", r"customer.*vendor",
            ...
            r"\d+,?\d{3}\s*(eur|usd|inr|gbp|cny|us\$|Ã¢ÂÂ¬|ÃÂ£|ÃÂ¥)",
            r"\$ ?\d+,?\d{3}",
            r"(Ã¢ÂÂ¬|ÃÂ£|ÃÂ¥)\s*\d+,?\d{3}",
        ],

        # Ã¢ÂÂÃ¢ÂÂ 6. Negotiation intelligence Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "negotiation": [
        ...
        # Ã¢ÂÂÃ¢ÂÂ 7. QM long text / quality analysis Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
        "qm_long_text": [
        ...
        # Ã¢ÂÂÃ¢ÂÂ 8. Quantity/amount threshold (standalone structural signal) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    # Dimension weights Ã¢ÂÂ sum = 1.0
    # single cross_module_join (0.8 ÃÂ 0.30) = 0.24 Ã¢ÂÂ SIMPLE
    # comparison + cross_module_join (0.8 ÃÂ 0.40) = 0.32 Ã¢ÂÂ SIMPLE
    # multi_entity + comparison + cross_module_join (0.8 ÃÂ 0.48) = 0.384 Ã¢ÂÂ COMPLEX
    # 3 semantic dims (0.8 ÃÂ 0.58) = 0.464 Ã¢ÂÂ COMPLEX
    # 4+ dims (0.8 ÃÂ 0.68) = 0.544 Ã¢ÂÂ EXPERT
    DIMENSION_WEIGHTS: Dict[str, float] = {
        ...
        "negotiation":         0.24,   # 0.8 * 0.24 = 0.192 Ã¢ÂÂ helps multi+xmod+neg cross 0.50
        "qm_long_text":       0.10,
        "qty_threshold":      0.02,   # Small weight Ã¢ÂÂ structural only
    }
    ...
    SIMPLE_THRESHOLD: float  = 0.30   # Any signal Ã¢ÂÂ SIMPLE
    COMPLEX_THRESHOLD: float = 0.50

    # Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Structural signal boost Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    STRUCTURAL_SIGNALS: Dict[str, float] = {
        ...
        # SAP document types
        r"(purchase|Ã©ÂÂÃ¥ÂÂ®) order\b":                    0.05,
        r"(sales|Ã©ÂÂÃ¥ÂÂ®) order\b":                       0.05,
...
class ComplexityRouter:
    ...
    def route(
        ...
        # Sam Bhagwat (Mastra): "Agents given too many tools perform worse."
        enabled_tools = _TOOL_GATES.get(tier, _TOOL_GATES[RoutingTier.COMPLEX])
    ...
    # ── Priority 9: Dynamic Tool Injection by Tier ─────────────────────────
    # Sam Bhagwat (Mastra): "Agents given too many tools perform worse."
    # Each tier gets exactly the tools it needs — no tool overload.
    TOOL_GATES: Dict[RoutingTier, List[str]] = {
        RoutingTier.TRIVIAL: ["sql_pattern_lookup", "sql_execute"],
        RoutingTier.SIMPLE:  ["sql_pattern_lookup", "sql_execute",
                               "schema_lookup", "mask_results"],
        RoutingTier.COMPLEX: ["schema_lookup", "sql_pattern_lookup",
                               "graph_enhanced_schema_discovery",
                               "all_paths_explore", "steiner_tree_explore",
                               "self_critique", "sql_execute", "mask_results",
                               "meta_path_match"],
        RoutingTier.EXPERT:  ["schema_lookup", "sql_pattern_lookup",
                               "graph_enhanced_schema_discovery",
                               "all_paths_explore", "steiner_tree_explore",
    ...
    def _get_enabled_tools(self, tier: RoutingTier) -> List[str]:
        """Return the tools enabled for this routing tier."""
        return list(self.TOOL_GATES.get(tier, self.TOOL_GATES[RoutingTier.COMPLEX]))


# Module-level _TOOL_GATES for route() closure access
_TOOL_GATES: Dict[RoutingTier, List[str]] = {
    RoutingTier.TRIVIAL: ["sql_pattern_lookup", "sql_execute"],
    RoutingTier.SIMPLE:  ["sql_pattern_lookup", "sql_execute", "schema_lookup", "mask_results"],
    RoutingTier.COMPLEX: ["schema_lookup", "sql_pattern_lookup",
                          "graph_enhanced_schema_discovery", "all_paths_explore",
                          "steiner_tree_explore", "self_critique",
                          "sql_execute", "mask_results", "meta_path_match"],
    RoutingTier.EXPERT:  ["schema_lookup", "sql_pattern_lookup",
                          "graph_enhanced_schema_discovery", "all_paths_explore",
                          "steiner_tree_explore", "self_critique", "dry_run_validation",
                          "sql_execute", "mask_results", "meta_path_match",
                          "temporal_graph_search", "qm_semantic_search",
                          "negotiation_brief", "voting_sql_generate"],
}
